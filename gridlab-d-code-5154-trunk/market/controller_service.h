/** $Id: controller_service.h 4738 2014-07-03 00:55:39Z dchassin $
	Copyright (C) 2009 Battelle Memorial Institute
	@file controller_service.h
	@addtogroup controller_service
	@ingroup market

 **/

#ifndef _controller_service_H
#define _controller_service_H
...
class controller_service : public gld_object {
	
public:
	
	controller_service(MODULE *);
	int create(void);
